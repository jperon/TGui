...
return describe("Relation display backend", function()
  before_each(function()
    ...
    for _index_0 = 1, #all_spaces do
      ...
      if space.name:match('^test_rel_display_') then
        spaces.delete_user_space(space.id)
      end
    end
  end)
  it("should create and list relations correctly", function()
    ...
    return assert(rel.reprFormula == tostring(self.label), "Repr formula should match")
  end)
