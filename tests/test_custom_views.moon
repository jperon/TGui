...
R.describe "CustomViews — création", ->
  R.it "createCustomView retourne les métadonnées", ->
    res = cvr.Mutation.createCustomView {}, { input: { name: CV_NAME, description: 'test', yaml: YAML_SIMPLE } }, {}
    R.ok res
    R.ok res.id
