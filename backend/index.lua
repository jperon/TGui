...
local change_type_select
change_type_select = function()
  local opts = {
...
make_fields_panel = function()
  return H.aside({
    ...
    H.div({
      ...
      H.div({
        id = 'field-repr-section',
        H.label({
          class = 'formula-hint',
          ['for'] = 'field-repr-formula',
          'Représentation (affichage) :'
        }),
        H.textarea({
          id = 'field-repr-formula',
          rows = '2',
        ...
        H.span({
          class = 'formula-hint',
          'Formule MoonScript/Lua de rendu visuel (ne modifie pas la donnée brute).'
        })
      }),
      H.div({
        ...
        H.button({
          id = 'field-change-type-btn',
          class = 'hidden toolbar-btn toolbar-btn--warn',
          title = 'Changer le type de ce champ',
          '⇄ Type…'
        })
      })
    })
    ...
    H.div({
      ...
      H.div({
        ...
        H.div({
          ...
          H.label({
            class = 'formula-hint',
            'Formule de conversion (optionnelle) :'
          }),
          H.div({
            class = 'formula-lang-row',
            H.label({
              class = 'formula-hint',
              ['for'] = 'change-type-lang',
              'Langage :'
            }),
            H.select({
              id = 'change-type-lang',
        ...
        H.div({
          class = 'modal-actions',
          H.button({
            id = 'change-type-confirm-btn',
            class = 'btn-primary',
            'Confirmer'
          }),
          H.button({
            id = 'change-type-cancel-btn',
            class = 'toolbar-btn',
            'Annuler'
          })
        })
